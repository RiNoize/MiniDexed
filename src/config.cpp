...
void CConfig::Load (void)
{
	...
	m_nMIDIButtonTG1 = m_Properties.GetNumber ("MIDIButtonTG1", 0);
	m_nMIDIButtonTG2 = m_Properties.GetNumber ("MIDIButtonTG2", 0);
	m_nMIDIButtonTG3 = m_Properties.GetNumber ("MIDIButtonTG3", 0);
	m_nMIDIButtonTG4 = m_Properties.GetNumber ("MIDIButtonTG4", 0);
	m_nMIDIButtonTG5 = m_Properties.GetNumber ("MIDIButtonTG5", 0);
	m_nMIDIButtonTG6 = m_Properties.GetNumber ("MIDIButtonTG6", 0);
	m_nMIDIButtonTG7 = m_Properties.GetNumber ("MIDIButtonTG7", 0);
	m_nMIDIButtonTG8 = m_Properties.GetNumber ("MIDIButtonTG8", 0);
...
unsigned CConfig::GetMIDIButtonTG1 (void) const
{
	return m_nMIDIButtonTG1;
}

unsigned CConfig::GetMIDIButtonTG2 (void) const
{
	return m_nMIDIButtonTG2;
}

unsigned CConfig::GetMIDIButtonTG3 (void) const
{
	return m_nMIDIButtonTG3;
}

unsigned CConfig::GetMIDIButtonTG4 (void) const
{
	return m_nMIDIButtonTG4;
}

unsigned CConfig::GetMIDIButtonTG5 (void) const
{
	return m_nMIDIButtonTG5;
}

unsigned CConfig::GetMIDIButtonTG6 (void) const
{
	return m_nMIDIButtonTG6;
}

unsigned CConfig::GetMIDIButtonTG7 (void) const
{
	return m_nMIDIButtonTG7;
}

unsigned CConfig::GetMIDIButtonTG8 (void) const
{
	return m_nMIDIButtonTG8;
}

unsigned CConfig::GetMIDIButtonEffects (void) const
{
	return m_nMIDIButtonEffects;
}

unsigned CConfig::GetMIDIButtonMasterVolume (void) const
{
	return m_nMIDIButtonMasterVolume;
}
